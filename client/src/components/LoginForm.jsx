        ...
        <form onSubmit={handleSubmit} className="flex flex-col items-center gap-3">
          ...
          <div className="w-full flex gap-2 mt-1">
            <button
              type="submit"
              disabled={loading}
              className="flex-1 py-3 rounded text-white font-semibold text-base cursor-pointer hover:opacity-90 transition-opacity"
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex-1 py-3 rounded text-white font-bold text-sm text-center flex items-center justify-center gap-1 hover:opacity-90 transition-opacity"
